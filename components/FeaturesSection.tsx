...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description }) => (
  <div className="w-5/6 md:w-full flex-shrink-0 bg-black/30 backdrop-blur-xl border border-white/20 rounded-2xl p-6 text-center flex flex-col items-center transition-all duration-300 hover:scale-103 hover:-translate-y-1 hover:shadow-xl will-change-transform">
  ...
  return (
    <section id="features" className="py-16 sm:py-20 overflow-hidden">
      <div className="container mx-auto">
        ...
        <div 
          className="flex space-x-6 overflow-x-auto md:overflow-visible md:grid md:grid-cols-3 md:gap-8 md:space-x-0 px-4 md:px-0 pb-4 animate-fade-in-slide-up hide-scrollbar"
