  ...
  return (
    <div className="flex flex-col h-full space-y-12">
      ...
      <div className="space-y-6">
        ...
        <div className="px-2">
            <p className="text-[9px] font-black text-primary uppercase tracking-[0.4em] font-mono mb-2">Account Control</p>
            <h2 className="text-xl font-black text-white tracking-tighter uppercase">{userName}</h2>
        </div>
      </div>
      ...
      <div className="mt-auto pt-8 border-t border-white/5">
        ...
        >
          ...
          <span className="text-[11px] font-black uppercase tracking-[0.2em] font-mono">Encerrar Sessão</span>
        </button>
      </div>
    </div>
  );
