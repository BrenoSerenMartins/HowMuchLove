      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 animate-fade-in-slide-up" style={{ animationDelay: '100ms' }}>
          <h2 className="text-3xl sm:text-4xl font-bold text-white">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-400">{uiCopy.marketing.socialProof.titleHighlight}</span>
          </h2>
        ...
        >
          {uiCopy.marketing.socialProof.testimonials.map((testimonial) => (
            <TestimonialCard 
